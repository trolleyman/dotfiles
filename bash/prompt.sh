...
__set_bash_prompt() {
	...
	local preGitPS1="$infoStrPS1 \[\033[G\]$__COL_W[${__COL_W}bash$__COL_W] $__COL_BW$CONDA_PROMPT_MODIFIER$venv$__COL_CX\t $__COL_W\u$__COL_CX@$__COL_W\h $exitString $__COL_Y\w $__COL_BW"
